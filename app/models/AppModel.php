...
class AppModel extends Model
{
    ...
    public function get_slug($table = null,$slug = null,$field = null,$idSlug=null)
    {

        if(!isset($idSlug)){
            $idSlug =$this->get_id_slug($table);
        }
        ...
        if(!empty(self::checkField($table,$slug,$field))){
            $slug = "{$slug}-{$idSlug}";
            if(!empty(self::checkField($table,$slug,$field))){
               $this->get_slug($table,$slug,$field,$idSlug);
            }
        }
        return $slug;
    }
    ...
    public function get_id_slug($table)
    {
    ...
    public function insert_slug($table,$slug): int
    {
    ...
    public function insert_into_description($table,$id)
    {
    ...
    public function update_description($table,$id)
    {
        $name = $table . '_description';
    ...
    public function uploadImg(){
        ...
        $newFilePath = $_SERVER['DOCUMENT_ROOT'] . '/assets/img/' . $srcFileName;
